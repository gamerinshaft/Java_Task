...
public class RaderChart2 extends Applet {
  float pa[]=new float[5];
  float pa_second[]=new float[5];
  float max = 0;
  float sum = 0;
  float sum_second = 0;
  ...
  public void init() {
    ...
    pa[0]=90;pa[1]=100;pa[2]=100;pa[3]=80;pa[4]=160;
    pa_second[0]=30;pa_second[1]=40;pa_second[2]=60;pa_second[3]=50;pa_second[4]=80;
    int i;
    //値の比較
